...
let seed=934172;
function random() { window.__bfTrace?.add(8); seed=(Math.imul(seed,1664525)+1013904223)>>>0; return seed/4294967296; }

function proceduralTexture(kind) { window.__bfTrace?.add(10);
