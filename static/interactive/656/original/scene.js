...
function box(name, size, position, material, parent = architecture, shadows = true) {
...
function cylinder(name, radiusTop, radiusBottom, height, position, material, segments = 18, parent = architecture) {
...
function beamBetween(name, start, end, radius, material, parent) {
...
function glassPanel(name, size, position) {
