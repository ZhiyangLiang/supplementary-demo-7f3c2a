...
function addBox(name, size, position, material, rotation = [0, 0, 0], parent = scene) {
...
function addCylinder(name, radiusTop, radiusBottom, height, position, material, parent = scene, radial = 24) {
...
function addRail(x, z, length, alongZ = true) {
...
function addRelief(side, z, colors) {
  const x = side * 10.57;
...
function createPedestal(position, size = [1.2, 0.78, 1.2]) {
  const group = new THREE.Group();
