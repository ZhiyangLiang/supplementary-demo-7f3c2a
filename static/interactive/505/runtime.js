...
function addBox(parent, size, position, mat, rotation = [0, 0, 0]) {
...
function addCylinder(parent, radii, height, position, mat, radialSegments = 12) {
...
function setBetween(mesh, start, end) {
...
function createLimb(parent, radius, mat) {
...
function updateSamurai(samurai, state, isLeft) {
...
function updateRain(actionTime) {
...
function updateLighting(time, state) {
...
export { THREE, scene, camera, renderer, actionState, DURATION };
