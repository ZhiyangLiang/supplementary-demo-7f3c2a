...
function mulberry32(seed) { window.__bfTrace?.add(18);
  return () => {
...
function addBox(parent, size, position, material, rotation = null) { window.__bfTrace?.add(243);
...
function taperedBox(parent, backWidth, frontWidth, height, length, position, material) { window.__bfTrace?.add(253);
...
function ellipsoid(parent, radius, scale, position, material, detail = 20) { window.__bfTrace?.add(405);
...
function makeLimb(parent, topRadius, bottomRadius, material, segments = 10) { window.__bfTrace?.add(419);
  const mesh = new THREE.Mesh(
...
function placeBetween(mesh, from, to) { window.__bfTrace?.add(430);
...
function updateLegs(time, entrance) { window.__bfTrace?.add(687);
...
function updateRain(time) { window.__bfTrace?.add(726);
...
function updateScene(rawTime) { window.__bfTrace?.add(748);
