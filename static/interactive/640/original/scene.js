...
function roundedBox(width, height, depth, radius, material, bevel = 0.035) {
...
function roundedOutline(width, height, radius, depth, tubeRadius, material) {
...
function addWheel(parent, x, z, front = true) {
...
function interpolateCamera(startPosition, endPosition, startTarget, endTarget, amount, fovA, fovB) {
...
function updateCamera(time, handleExtension) {
  if (time < 1.15) {
