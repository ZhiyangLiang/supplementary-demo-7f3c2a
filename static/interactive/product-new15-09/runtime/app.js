...
function add(g,m,p,group=scene){ window.__bfTrace?.add(17);const o=new THREE.Mesh(g,m);if(p)o.position.set(...p);o.castShadow=true;o.receiveShadow=true;group.add(o);return o;}
function rr(w,h,r){ window.__bfTrace?.add(18);const s=new THREE.Shape(),x=-w/2,y=-h/2;s.moveTo(x+r,y);s.lineTo(x+w-r,y);s.quadraticCurveTo(x+w,y,x+w,y+r);s.lineTo(x+w,y+h-r);s.quadraticCurveTo(x+w,y+h,x+w-r,y+h);s.lineTo(x+r,y+h);s.quadraticCurveTo(x,y+h,x,y+h-r);s.lineTo(x,y+r);s.quadraticCurveTo(x,y,x+r,y);return s;}
function slab(w,h,r,depth,bevel,mat,p){ window.__bfTrace?.add(19);const g=new THREE.ExtrudeGeometry(rr(w,h,r),{depth,bevelEnabled:true,bevelThickness:bevel,bevelSize:bevel,bevelSegments:5,steps:1,curveSegments:24});g.translate(0,0,-depth/2);return add(g,mat,p);}
function disc(r,depth,mat,p){ window.__bfTrace?.add(20);const o=add(new THREE.CylinderGeometry(r,r,depth,64),mat,p);o.rotation.x=Math.PI/2;return o;}
...
function rod(a,b,r,m){ window.__bfTrace?.add(42);const av=new THREE.Vector3(...a),bv=new THREE.Vector3(...b),o=add(new THREE.CylinderGeometry(r,r,av.distanceTo(bv),24),m);o.position.copy(av).add(bv).multiplyScalar(.5);o.quaternion.setFromUnitVectors(new THREE.Vector3(0,1,0),bv.sub(av).normalize());return o;}
...
function band(points,width,thickness,mat,axis='x'){ window.__bfTrace?.add(47);
