...
function book(parent, name, x, y, z, w, h, d, index, tilt = 0) {
...
function stack(parent, x, y, z, count, seed, w = .34) {
...
function paperStack(parent, x, y, z, count, seed, w = .34) {
  const rng = random(seed);
  for (let i = 0; i < count; i++) {
...
function picture(parent, x, y, z, w, h, seed) {
