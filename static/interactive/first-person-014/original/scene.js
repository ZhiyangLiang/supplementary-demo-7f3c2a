...
function makeBox(parent, size, position, material, rotation = null) {
...
function makeSphere(parent, radius, position, material, scale = null, detail = 1) {
...
function makeCylinder(parent, radiusTop, radiusBottom, height, position, material, radial = 8) {
...
function placeBetween(mesh, start, end, thickness = 1) {
