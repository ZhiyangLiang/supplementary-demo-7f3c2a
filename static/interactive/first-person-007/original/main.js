...
function makeRibbon(width, heightOffset, material) {
  const segments = 110;
  const positions = [];
  const indices = [];
...
function addCastleTower(parent, x, z, radius, height) {
...
function updateHand(hand, time, deploy) {
